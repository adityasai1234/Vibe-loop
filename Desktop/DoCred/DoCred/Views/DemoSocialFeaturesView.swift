...
struct DemoSocialFeaturesView: View {
    ...
    let mockTask = Task(id: "task1", title: "Take out trash", description: "Take out the trash before 8pm", status: .approved, proof: [], createdAt: Date(), updatedAt: nil, assignedTo: "demoUser1", reviewedBy: nil, score: nil, teamId: nil)
