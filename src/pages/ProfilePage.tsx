      ...
      <div className="relative">
        ...
        <div className="absolute -bottom-16 left-0 w-full px-6 flex flex-col md:flex-row items-start md:items-end">
          ...
          <div className="flex space-x-4 mt-4 md:mt-0 md:ml-auto md:mb-2">
            <button className="flex items-center space-x-2 rounded-full bg-white/10 px-4 py-2 hover:bg-white/20 transition-colors">
              <Edit size={18} />
      ...
      <div className="px-6 pt-24 pb-8">
        <div className="flex flex-wrap gap-8 mb-10">
          <div className="flex items-center space-x-2">
            ...
            <span className="text-gray-300">{currentUser.followers} Followers</span>
          </div>
          <div className="flex items-center space-x-2">
            <Users size={20} className="text-gray-400" />
            <span className="text-gray-300">{currentUser.following} Following</span>
          </div>
          <div className="flex items-center space-x-2">
            <Music size={20} className="text-gray-400" />
            <span className="text-gray-300">{favoriteSongs.length} Favorite Songs</span>
          </div>
          <div className="flex items-center space-x-2">
            <ListMusic size={20} className="text-gray-400" />
            <span className="text-gray-300">{userPlaylists.length} Playlists</span>
          </div>
        </div>
