...
export const LoginPage: React.FC = () => {
  const { currentUser, signInWithGoogle, loading: authLoading } = useAuthContext();
  ...
  return (
    <div className="min-h-screen bg-gray-900 text-white flex flex-col justify-center items-center p-4">
      <div className="w-full max-w-sm p-8 space-y-8 bg-gray-800 rounded-lg shadow-xl text-center">
        ...
        {(loading || authLoading) && <p className="mt-4 text-sm text-gray-400">Attempting to sign you in...</p>}
      </div>
    </div>
  );
};
